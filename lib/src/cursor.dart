...
class Cursor {
  ...
  Cursor mapKeyWithTypes(dynamic key, FieldDescriptorProto_Type keyType,
...
class PrefixedRulePathCursor extends Cursor {
  ...
  void violate({
    ...
    final combinedRulePath =
        rulePath != null ? _baseRulePath.appendPath(rulePath) : _baseRulePath;
  ...
  @override
  Cursor field(FieldInfo field) =>
      PrefixedRulePathCursor(super.field(field), _baseRulePath);

  @override
  Cursor listIndex(int index) =>
      PrefixedRulePathCursor(super.listIndex(index), _baseRulePath);

  @override
  Cursor mapKey(dynamic key) =>
      PrefixedRulePathCursor(super.mapKey(key), _baseRulePath);

  @override
  Cursor mapKeyWithTypes(dynamic key, FieldDescriptorProto_Type keyType,
          FieldDescriptorProto_Type valueType) =>
      PrefixedRulePathCursor(
          super.mapKeyWithTypes(key, keyType, valueType), _baseRulePath);
}
