...
class ConformanceRegistryGenerator extends Generator {
  ...
  FutureOr<String?> generate(LibraryReader library, BuildStep buildStep) async {
    ...
    buffer.writeln("import 'package:protovalidate/src/gen/google/protobuf/timestamp.pb.dart';");
    buffer.writeln("import 'package:protovalidate/src/gen/google/protobuf/duration.pb.dart';");
    buffer.writeln("import 'package:protovalidate/src/gen/google/protobuf/wrappers.pb.dart';");
    buffer.writeln('');
    ...
    buffer.writeln('  ');
    buffer.writeln('  // First try to lookup in the provided registry');
    buffer.writeln('  final builderInfo = registry.lookup(typeName);');
    buffer.writeln('  GeneratedMessage? message;');
    buffer.writeln('  ');
    buffer.writeln('  if (builderInfo != null && builderInfo.createEmptyInstance != null) {');
    buffer.writeln('    message = builderInfo.createEmptyInstance!();');
    buffer.writeln('  } else {');
    buffer.writeln('    // Fallback: handle well-known types that might not be in the registry');
    buffer.writeln('    message = _createWellKnownType(typeName);');
    buffer.writeln('  }');
    buffer.writeln('');
    buffer.writeln('  if (message == null) return null;');
    buffer.writeln('');
    ...
    buffer.writeln('}');
    buffer.writeln('');
    buffer.writeln('/// Create instances of well-known types');
    buffer.writeln('GeneratedMessage? _createWellKnownType(String typeName) {');
    buffer.writeln('  switch (typeName) {');
    buffer.writeln('    case \'google.protobuf.Any\':');
    buffer.writeln('      return Any();');
    buffer.writeln('    case \'google.protobuf.Timestamp\':');
    buffer.writeln('      return Timestamp();');
    buffer.writeln('    case \'google.protobuf.Duration\':');
    buffer.writeln('      return Duration();');
    buffer.writeln('    case \'google.protobuf.BoolValue\':');
    buffer.writeln('      return BoolValue();');
    buffer.writeln('    case \'google.protobuf.StringValue\':');
    buffer.writeln('      return StringValue();');
    buffer.writeln('    case \'google.protobuf.Int32Value\':');
    buffer.writeln('      return Int32Value();');
    buffer.writeln('    case \'google.protobuf.Int64Value\':');
    buffer.writeln('      return Int64Value();');
    buffer.writeln('    case \'google.protobuf.UInt32Value\':');
    buffer.writeln('      return UInt32Value();');
    buffer.writeln('    case \'google.protobuf.UInt64Value\':');
    buffer.writeln('      return UInt64Value();');
    buffer.writeln('    case \'google.protobuf.FloatValue\':');
    buffer.writeln('      return FloatValue();');
    buffer.writeln('    case \'google.protobuf.DoubleValue\':');
    buffer.writeln('      return DoubleValue();');
    buffer.writeln('    case \'google.protobuf.BytesValue\':');
    buffer.writeln('      return BytesValue();');
