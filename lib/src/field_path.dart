...
class FieldPath {
  ...
  FieldPath._(List<pb.FieldPathElement> elements)
  ...
  FieldPath mapKeyWithTypes(dynamic key, FieldDescriptorProto_Type? keyType,
      FieldDescriptorProto_Type? valueType) {
    if (_elements.isEmpty) {
  ...
  pb.FieldPathElement _createOneofElement(String oneofName) {
    final element = pb.FieldPathElement()..fieldName = oneofName;
...
class RulePath {
  ...
  RulePath._(List<pb.FieldPathElement> elements)
      : _elements = List.from(elements);
  ...
  RulePath constraint(String constraintName, int fieldNumber,
      FieldDescriptorProto_Type fieldType) {
    final newPath = clone();
    newPath._elements.add(pb.FieldPathElement()
      ..fieldNumber = fieldNumber
  ...
  /// The extensionName should already be fully qualified (e.g., [package.name.extension])
...
class RulePathElement {
  ...
  /// The extensionId should be the fully qualified extension name
